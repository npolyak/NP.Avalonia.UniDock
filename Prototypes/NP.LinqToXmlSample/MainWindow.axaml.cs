...
namespace NP.LinqToXmlSample
{
    public partial class MainWindow : Window
    {
        ...
        public void PrepareForSerialization()
        {
            ...
            var winParams = dockManagerParams.WindowsSerializationParams![0];

            XDocument doc = XDocument.Load("../../../../SerializationResult.xml");

            doc.Root.Descendants().First();
        }
    }
}
